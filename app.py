...
# ATUALIZADO: Hashes reais validados pelo usuário (2026-05-26)
# Servidor correto: arquivos.esusaps.ufsc.br
# Nota: Hashes são únicos por versão e não seguem padrão previsível
# Estratégia: Manter lista estativa + scraping automático para novas versões
HASHES_CONHECIDOS = {
    # Versões 5.4.x - Hashes validados pelo usuário
    "5.4.36": "01385542bd35ba1e",  # ✅ Validado
    "5.4.33": "b8fff95d65352039",  # ✅ Validado
    "5.4.31": "48005440f1a35d3d",  # ✅ Validado
    "5.4.30": "c7be198724ac4839",  # ✅ Validado
    # Versões 5.4.x - A descobrir (usar scraping)
    # "5.4.37": "???",  # Será descoberto por scraping
    # "5.4.35": "???",  # Será descoberto por scraping
    # "5.4.34": "???",  # Será descoberto por scraping
    # "5.4.32": "???",  # Será descoberto por scraping
